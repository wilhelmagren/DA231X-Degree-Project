...
plt.savefig('t-SNE_features_recording.png')
plt.clf()
...
plt.savefig('clustering_scores_recording.png')
plt.clf()
...
plt.savefig('kmeans_clustering_recording.png')
...
plt.savefig('silhouette_stuffs_recording.png')