...
class SLEMEG(BaseConcatDataset):
    def __init__(self, subjects=None, recordings=None, preload=False, load_meg_only=True):
        if subjects is None:
        ...
        super().__init__(self._fetch_and_load(
            subjects, recordings, preload, load_meg_only))

    def _fetch_and_load(self, subjects, recordings, preload, load_meg_only):
